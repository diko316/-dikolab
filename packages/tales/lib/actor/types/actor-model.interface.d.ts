...
import type { NAME_KEY, ROLES_KEY } from '../../utils/constants/symbol-keys.constant';
...
export interface ActorModel<Name extends string, Roles extends readonly AnyRole[]> extends UsecaseSymbol<typeof ACTOR_TYPE, Name, ActorEventMap> {
