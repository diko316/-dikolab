...
import type { BOUNDARY_KEY, TITLE_KEY } from '../../utils/constants/symbol-keys.constant';
...
export interface GoalModel<Title extends string, Boundary extends AnyBoundary> extends UsecaseSymbol<typeof GOAL_TYPE, GoalName<Title, Boundary>, GoalEventMap> {
